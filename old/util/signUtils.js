 ...
 * @return
 */
exports.buildCanonicalizedResource = function buildCanonicalizedResource(
  resourcePath,
  parameters
) {
 ...
 */
exports.buildCanonicalString = function canonicalString(
  method,
  resourcePath,
  request,
  expires
  ...
  signContent.push(
    this.buildCanonicalizedResource(resourcePath, request.parameters)
  );
 ...
 */
exports.computeSignature = function computeSignature(
  accessKeySecret,
  canonicalString,
...
exports._signatureForURL = function _signatureForURL(
  ...
  if (Object.prototype.hasOwnProperty.call(options, "callback")) {
    ...
    if (options.callback.customValue) {
      ...
      subResource["callback-var"] = Buffer.from(
